...
* **Embedded & IoT:** ![VS Code](https://img.shields.io/badge/VS%20Code-007ACC?style=flat-square&logo=visual-studio-code&logoColor=white) ![Microchip Studio](https://img.shields.io/badge/Microchip-Studio-blue) `Proteus/ISIS` `PCB Design`
* **Industrial & Simulation:** ![MATLAB](https://img.shields.io/badge/MATLAB-ED1C24?style=flat-square&logo=mathworks&logoColor=white)`AutoCAD Electrical`
* **Machine Learning:** Scikit-Learn, Predictive Modeling for Healthcare.
...
* **Healthcare Communication API:** Developed in **C#**, facilitating real-time notifications between doctors, nurses, and pharmacists.
